...
def main(argv=None):
    ...
    for iteration in range(training_length):
        ...
        for environment_step in range(episode_length // episode_mini_batch_length):
            state_history = []
            ...
            masks_episode = []
            keys_episode = []
            for mini_batch_step in range(episode_mini_batch_length):
            ...
            model_state, loss = model_utilities.train_step(
                ...
                keys=keys_episode,
                batch_size=num_envs,
                episode_length=episode_mini_batch_length,
                ppo_steps=ppo_steps,
            )
